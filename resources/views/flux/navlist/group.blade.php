...
>
    <button
        type="button"
        class="group/disclosure-button mb-[2px] flex h-10 w-full items-center rounded-lg text-kb-white-ghost/60 hover:bg-kb-blue-light/10 hover:text-kb-white-ghost lg:h-8"
    >
        <div class="ps-3 pe-4">
    ...
    <div class="relative hidden space-y-[2px] ps-7 data-open:block" @if ($expanded === true) data-open @endif>
        <div class="absolute inset-y-[3px] start-0 ms-4 w-px bg-kb-blue-light/20"></div>
...
<div {{ $attributes->class('block space-y-[2px]') }}>
    <div class="px-1 py-2">
        <div class="text-xs leading-none text-kb-white-ghost/40">{{ $heading }}</div>
    </div>
